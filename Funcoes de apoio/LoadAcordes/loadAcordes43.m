function [dataOut] = loadAcordes43(dataIn,recdelay)
...
nomeMic='Acordes_Mic_43.wav';
nomeLine='Acordes_Line_43.wav';
...
%findpeaks(log10(1+abs(yMicFFT(1:end/2))),NPeaks=2000,SortStr="descend",MinPeakDistance=150,MinPeakProminence=0.25);        
[~,indListMic]=findpeaks(log10(1+abs(yMicFFT(1:end/2))),NPeaks=2000,SortStr="descend",MinPeakDistance=150,MinPeakProminence=0.25);        
%%
...
%findpeaks(log10(1+abs(yLineFFT(1:end/2))),NPeaks=2000,SortStr="descend",MinPeakDistance=150,MinPeakProminence=0.25);   
[~,indListLine]=findpeaks(log10(1+abs(yLineFFT(1:end/2))),NPeaks=2000,SortStr="descend",MinPeakDistance=150,MinPeakProminence=0.25);   
