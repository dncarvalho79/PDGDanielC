function [dataOut] = loadAcordes49(dataIn,recdelay)
...
nomeMic='Acordes_Mic_49.wav';
nomeLine='Acordes_Line_49.wav';
...
%findpeaks(log10(1+abs(yLineFFT(1:end/2))),NPeaks=2000,SortStr="descend",MinPeakDistance=150,MinPeakProminence=0.1);   
[~,indListLine]=findpeaks(log10(1+abs(yLineFFT(1:end/2))),NPeaks=2000,SortStr="descend",MinPeakDistance=150,MinPeakProminence=0.1);   
