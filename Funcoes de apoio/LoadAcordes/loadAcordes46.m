function [dataOut] = loadAcordes46(dataIn,recdelay)
...
nomeMic='Acordes_Mic_46.wav';
nomeLine='Acordes_Line_46.wav';
...
%findpeaks(log10(1+abs(yMicFFT(1:end/2))),NPeaks=2000,SortStr="descend",MinPeakDistance=150,MinPeakProminence=0.1);        
[~,indListMic]=findpeaks(log10(1+abs(yMicFFT(1:end/2))),NPeaks=2000,SortStr="descend",MinPeakDistance=150,MinPeakProminence=0.1);        
%%
