function [dataOut] = loadAcordes12(dataIn,recdelay)
...
nomeMic='Acordes_Mic_12.wav';
nomeLine='Acordes_Line_12.wav';
...
%findpeaks(log10(1+abs(yMicFFT(1:end/2))),NPeaks=2000,SortStr="descend",MinPeakDistance=150,MinPeakProminence=0.3);        
[~,indListMic]=findpeaks(log10(1+abs(yMicFFT(1:end/2))),NPeaks=2000,SortStr="descend",MinPeakDistance=150,MinPeakProminence=0.3);        
%%
...
%findpeaks(log10(1+abs(yLineFFT(1:end/2))),NPeaks=2000,SortStr="descend",MinPeakDistance=150,MinPeakProminence=0.3);   
[~,indListLine]=findpeaks(log10(1+abs(yLineFFT(1:end/2))),NPeaks=2000,SortStr="descend",MinPeakDistance=150,MinPeakProminence=0.3);   
