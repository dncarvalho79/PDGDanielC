function [dataOut] = loadData3_100(dataIn, plotOn,recdelay)
...
%Load com findpeaks individual nota 47
casaCorda='10E2';
minPeakDist=50;
...
nomeMic='Corda_E2_Mic_47.wav';
nomeLine='Corda_E2_Line_47.wav';
    ...
    data=dataProcess3(HarmMic,HarmLine,casaCorda);
